...
export default function DonutCheckinChart() {
  ...
  const {isLoading,data} = useQuery('getcheckinsemployeesdonut',()=>{
  ...
  const chartData = [
    { id: "checkins", employees: employees.length,fill: "#2563eb" },
  ...
  return (
    <Card className="flex flex-col">
      <CardHeader className="items-center pb-0">
        <CardTitle>No of Checkins recorded</CardTitle>
        <CardDescription>chart showing number of checkins recorded in the organization</CardDescription>
      </CardHeader>
